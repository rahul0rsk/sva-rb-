...
export const Header: React.FC<HeaderProps> = ({ title, subtitle, children, notifications, onMarkAllAsRead, currentUser, onGlobalSearch, onToggleSidebar, onOpenDialPad }) => {
    const showDialPadButton = ![Role.Agent, Role.Trainee].includes(currentUser.role) && title === 'Dashboard';
