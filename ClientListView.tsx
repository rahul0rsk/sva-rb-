...
export const ClientListView: React.FC<ClientListViewProps> = (props) => {
  const { 
    ...
    onAddInteraction, onBulkAssign, onBulkEmail, currentUser, can, onToggleSidebar, initialFilters,
// FIX: Removed incorrect destructuring of shiftTrackerProps. Individual props are used directly.
  } = props;
  ...
  return (
    <div className="p-4 sm:p-6 bg-slate-900 min-h-screen">
      <Header 
        ...
        totalBreakDuration={props.totalBreakDuration}
        onToggleBreak={props.onToggleBreak}
      />
