...
export const CheckSquareIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const AdminPanelIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ReportsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M8 6H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-4"></path>
    <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
    <path d="M16 14h-4"></path><path d="M16 18h-8"></path><path d="M10 10h.01"></path>
  </svg>
);
...
export const RupeeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12"></path><path d="M6 8h12"></path><path d="M6 13h12"></path><path d="M6 18h12"></path><path d="M6 23h12"></path><path d="M18 3v20"></path><path d="M12 3v20"></path></svg>
);
export const LoanIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 17l-5.89-5.89a2 2 0 0 1 0-2.82l9.8-9.8a2 2 0 0 1 2.82 0L21 5.41a2 2 0 0 1 0 2.82L15.11 14.1A2 2 0 0 1 14 15l-3 3-3-3z"></path><path d="M8 17l-1.93-1.93"></path><path d="m2 2 4 4"></path></svg>
);

export const ConversionRateIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 2v6h6"></path><path d="M21.5 22v-6h-6"></path><path d="M15 15l6 6"></path><path d="M3.23 8.56A10 10 0 0 1 20 6.5"></path></svg>
);
...
export const BulkAssignIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 15v4a2 2 0 0 0 2 2h9"/>
    <path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/>
    <path d="M12 14c-2.67 0-8 1.34-8 4v2h9"/>
    <path d="M21 12h-6"/>
...
export const EmailIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/></svg>
);
...
export const HistoryIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 4v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></svg>
);
...
export const EndCallIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M20 15.5c-1.25 0-2.45-.2-3.57-.57-.35-.11-.74-.03-1.02.24l-2.2 2.2c-2.83-1.44-5.15-3.75-6.59-6.59l2.2-2.2c.28-.28.36-.67.25-1.02C8.7 6.45 8.5 5.25 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1z"/></svg>
);
...
export const ActiveAgentIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
    </svg>
);

export const AddAgentIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m12 3-1.5 5-5-1.5L7 12l-5 1.5L7 15l-1.5 5 5-1.5L12 21l1.5-5 5 1.5L17 15l5-1.5-5-1.5 1.5-5-5 1.5Z" />
    </svg>
);
...
export const SmsIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM9 11H7V9h2v2zm4 0h-2V9h2v2zm4 0h-2V9h2v2z" />
    </svg>
);

export const MuteIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 14c1.66 0 2.99-1.34 2.99-3L15 5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm-1.2-9.1c0-.66.54-1.2 1.2-1.2.66 0 1.2.54 1.2 1.2l-.01 6.2c0 .66-.53 1.2-1.19 1.2-.66 0-1.2-.54-1.2-1.2V4.9zm6.5 4.1c0 3-2.54 5.1-5.3 5.1S6.7 12 6.7 9H5c0 3.41 2.72 6.23 6 6.72V19h2v-3.28c3.28-.49 6-3.31 6-6.72h-1.7z" />
    </svg>
);

export const HoldIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" />
    </svg>
);

export const TransferIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="m20 18-4-4 4-4 1.41 1.41L18.83 14l2.58 2.59zM12 6l-1.41 1.41L13.17 10H4v2h9.17l-2.58 2.59L12 16l4-4-4-4z" />
    </svg>
);
...
export const CakeIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 3c-1.1 0-2 .9-2 2v1.5c0 .28.22.5.5.5h3c.28 0 .5-.22.5-.5V5c0-1.1-.9-2-2-2zm10 16v1c0 .55-.45 1-1 1H3c-.55 0-1-.45-1-1v-1h20zm-1-7H3c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h18c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1z"/>
    </svg>
);
...
export const PdfIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M20 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2zM9.5 11.5c0 .83-.67 1.5-1.5 1.5H7v-3h1c.83 0 1.5.67 1.5 1.5v0zm-1.5-2.5H7V14h1.5c1.38 0 2.5-1.12 2.5-2.5S9.88 9 8.5 9zM15 14h-1v-2h1v2zm-3-4h1v1.5c0 .83-.67 1.5-1.5 1.5h-1.5v-5H12V10zm6.5 2.5c0 .83-.67 1.5-1.5 1.5h-2.5v-5H18c.83 0 1.5.67 1.5 1.5v2zM18 10.5h-1.5v3H18c.28 0 .5-.22.5-.5v-2c0-.28-.22-.5-.5-.5z"/>
    </svg>
);
...
export const PaletteIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.667 0-.424-.163-.83-.443-1.134A8.003 8.003 0 0 1 12 14c-4.418 0-8-3.582-8-8s3.582-8 8-8c.926 0 1.648-.746 1.648-1.667 0-.424-.163-.83-.443-1.134A8.003 8.003 0 0 1 12 2z"/>
    </svg>
);

export const ExcelIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M21.17 3.25Q21.5 3.25 21.76 3.5 22 3.75 22 4.09V19.91Q22 20.25 21.76 20.5 21.5 20.75 21.17 20.75H2.83Q2.5 20.75 2.24 20.5 2 20.25 2 19.91V4.09Q2 3.75 2.24 3.5 2.5 3.25 2.83 3.25H21.17M12 5.75V7.25H11V8.25H12V9.75H11V10.75H12V12.25H11V13.25H12V14.75H11V15.75H12V17.25H13V15.75H14V14.75H13V13.25H14V12.25H13V10.75H14V9.75H13V8.25H14V7.25H13V5.75H12M15 5.75V7.25H16V8.25H15V9.75H16V10.75H15V12.25H16V13.25H15V14.75H16V15.75H15V17.25H17.25V16.5L19 14.75V13.75L17.25 12V10.75L19 9V8L17.25 6.5V5.75H15M8.5 8.75L7.09 11.25L8.5 13.75H7.06L6 11.73L4.94 13.75H3.5L4.91 11.25L3.5 8.75H4.94L6 10.77L7.06 8.75H8.5Z" />
    </svg>
);

export const WordIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M2 2a2 2 0 00-2 2v16a2 2 0 002 2h16a2 2 0 002-2V4a2 2 0 00-2-2H2zm9 4h2l2 8-2 8H9l-2-8 2-8zm-4 0h2.5l-1 8-1.5-8zM17 6h-2.5l-1 8 1.5 8H17l-1-8 1-8z" />
    </svg>
);
